...
/* harmony import */ var _setAttributes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../setAttributes */ "./src/setAttributes.js");
    ...
    if (index === +event.target.dataset.index) {
      ...
      if (projTasks) {
        projTasks.forEach((taskObj, index) => {
          (0,_DOMElements_createTaskElement__WEBPACK_IMPORTED_MODULE_3__.createTaskElement)(taskObj, index, tasks);
        });
      }
...
const renderProjectTasks = () => {
  ...
  if (projTasks) {
    projTasks.forEach((taskObj, index) => {
      (0,_DOMElements_createTaskElement__WEBPACK_IMPORTED_MODULE_3__.createTaskElement)(taskObj, index, tasksHolder);
    });
  }
  deleteTaskListener();
  editTaskListener();
  ...
  if (projTasks) {
    for (let j = 0; j < projTasks.length; j++) {
      if (j === targetEditBtn) {
        ...
        (0,_DOMElements_createTask__WEBPACK_IMPORTED_MODULE_4__.closeTaskForm)();
        return;
      }
    }
  }
...
const modifyTaskSubmitListen = (projTasks, j) => {
  ...
  taskForm.addEventListener("submit", (event) => {
    ...
    (0,_toDoManager_toDoManager__WEBPACK_IMPORTED_MODULE_1__.modifyTask)(projTasks, j, newTitle);
    renderProjectTasks();
    formModalBg.style.display = "none";
    formContainer.style.display = "none";
  });
