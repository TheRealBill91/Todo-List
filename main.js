...
const createTaskCheckbox = (taskElement, index, leftSideContainer) => {
  ...
  (0,_setAttributes__WEBPACK_IMPORTED_MODULE_0__.setAttributes)(taskCheckbox, { class: `toggleTaskStatus`, "data-index": `${index}`, "type": "checkbox" })
...
const createTaskControls = (taskElement, taskValues, index) => {
  ...
  (0,_setAttributes__WEBPACK_IMPORTED_MODULE_0__.setAttributes)(editButton, { "data-index": `${index}`, class: "editButton" });
    ...
    if (index === +event.target.dataset.index) {
      ...
      if (projTasks) {
        projTasks.forEach((taskObj, index) => {
          (0,_DOMElements_createTaskElement__WEBPACK_IMPORTED_MODULE_4__.createTaskElement)(taskObj, index, tasks);
        });
      }
...
const renderProjectTasks = () => {
  ...
  if (projTasks) {
    projTasks.forEach((taskObj, index) => {
      (0,_DOMElements_createTaskElement__WEBPACK_IMPORTED_MODULE_4__.createTaskElement)(taskObj, index, tasksHolder);
    });
  }
  deleteTaskListener();
  editTaskListener();
...
const loadTaskValues = (currentTask) => {
  ...
  const dateObject = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(dateString);
  // You only need this version for the tasks you manually created
  // inside index.js
  // const parsedDate = parse(dateValue, 'MM/dd/yyyy', new Date());
  const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(dateObject, "yyyy-MM-dd");
